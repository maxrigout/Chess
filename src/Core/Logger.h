...
#define LOG_TRACE(msg) Logger::Trace(__FILE__, __func__, __LINE__, msg)
#define LOG_VERBOSE(msg) Logger::Verbose(__FILE__, __func__, __LINE__, msg)
...
#define LOG_WARN(msg) Logger::Warn(__FILE__, __func__, __LINE__, msg)
